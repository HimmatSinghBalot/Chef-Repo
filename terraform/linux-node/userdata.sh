...
CHEF_SERVER_NAME="devops-virtusams" # The name of your Chef Server
CHEF_SERVER_ENDPOINT="devops-virtusams-8ozhwfh9yrii0al9.us-east-1.opsworks-cm.io" # The FQDN of your Chef Server
...
RUN_LIST="recipe[chef-client],recipe[learn_chef_httpd],recipe[logrotate],recipe[ohai]" # e.g. "recipe[chef-client],recipe[ohai]"
